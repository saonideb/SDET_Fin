...
Partial Class SignIn
    ...
    Protected Sub linkPage_Click(sender As Object, e As EventArgs) Handles linkPage.Click
        ...
        con.Open()
        logincommand.CommandText = "SELECT * FROM Login_Details WHERE Username = '" & Session("Email").Trim().ToString() & " '"
        ...
        If objreader.Read Then
			...
			Session("Department_Divsion_Head_Email_Id") = objreader("Department_Head_Email_Id")
            ...
            If user_type = "Admin" Then
                ...
                If account_status = "Active" Then
                    Response.Redirect("Department_Division_Users/Account_Login_Details_Entry.aspx")
                Else
    ...
    Protected Sub Button2_Click1(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Session("Name") = "FIC IPC"
        Session("Email") = "fic.ipc@pilani.bits-pilani.ac.in"
