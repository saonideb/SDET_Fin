<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MailError.aspx.vb" Inherits="MailError" %>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td style="text-align: center">
                                                                    <img src="Images/Alert_Icon_New.jpeg" alt="" style="height: 43px"></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="vertical-align: middle; text-align: center;">
                                                                    <span style="font-size: 11pt; color: black"><strong><span style="font-size: 16pt"><span
                                                                        style="color: red">Please login through BITS Email ID & Password.</span><br />
                                                                    </span>
                                                                        <br /></td>
                                                            </tr>
                                                              <tr>
                                                                <td style="text-align: center">
                                                                  <a href="https://ipcservices.bits-pilani.ac.in/BAS/" class="linkButton" style="color: blue"><span style="font-size:18px"><strong>Please Click here to Login</strong></span></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
