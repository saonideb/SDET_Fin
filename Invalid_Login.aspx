<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Invalid_Login.aspx.vb" Inherits="Invalid_Login" %>
...
<table border="0"  align ="center"  class="body_txt_in" cellpadding="0" cellspacing="0" style="width: 600px; height: 55px; border: 1px solid #4a9ace">
	<tbody>
                    ...
                    <tr>
                        ...
                        <asp:HyperLink ID="LoginLink" runat="server" Font-Bold="True" NavigateUrl="https://ipcservices.bits-pilani.ac.in/BAS/" Font-Size="14px"> Please Enter the Correct Login Details</asp:HyperLink>
									</td>
								</tr>
							</table>
						</td>
