<%@ Page Title="" Language="VB" MasterPageFile="~/Individual_Users/MasterPage.master" AutoEventWireup="false" CodeFile="Individual_Approval_Travel.aspx.vb" Inherits="Individual_Users_Individual_Approval_Travel" %>
                ...
                <tbody>
                    ...
                    <div id="div_item_details" runat="server" visible="false">
                        ...
                        <tr>
                            <td colspan="3">
                                <div align="left" style="margin-left: 20px">
                                    <%--  <asp:GridView ID="DG1" runat="server" Width="90%"  AutoGenerateColumns="False" DataKeyNames="Record_Id,Reference_No" ShowFooter="true" CellSpacing="4"  CellPadding="6" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" OnRowCreated="GrdView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" >--%>
                                    <asp:GridView ID="DG1" runat="server" Width="90%" AutoGenerateColumns="False" ShowFooter="true" CellSpacing="4" CellPadding="6" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px">
                                    ...
                                    <td style="border:1px solid Black;border-collapse:collapse"><span style="font-size:12px;color:black"><strong>Approx. Total Cost (in Rs.)</strong></span></td>--%>
                                        ...
                                        <tr align="center" style="height: 50px; width: 300px">
                                            <td style="border: 1px solid Black; border-collapse: collapse">
                                                <asp:TextBox ID="txt_item_description" runat="server" autocomplete="off" CssClass="txt" Style="position: static" Height="40px" TabIndex="2" TextMode="MultiLine" Width="600px" MaxLength="5000" onChange="Replace_SpecialChars(this);" onKeyPress="Replace_SpecialChars(this);" onkeyup="Replace_SpecialChars(this);"></asp:TextBox>
                                            </td>
                                            <%--   <td style="border:1px solid Black;border-collapse:collapse;width:200px; vertical-align:top; margin-top:2px" >
                                     <asp:TextBox ID="txt_item_quantity" runat="server" autocomplete="off"  CssClass="txt" MaxLength="5" Font-Bold="true" ForeColor="Black" Font-Size="12px"  TabIndex="3" Width="180px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"></asp:TextBox>
                                    </td>--%>
                                ...
                                <table id="Table1" class="body_txt_in" style="border: 1px solid Black; border-collapse: collapse; width: 90%" cellspacing="0" cellpadding="6">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center" style="height: 50px;">
                                            <td style="border: 1px solid Black; border-collapse: collapse">
                                                <asp:TextBox ID="TextBox1" runat="server" autocomplete="off" CssClass="txt" Style="position: static" Height="24px" TabIndex="2" TextMode="MultiLine" Width="250px" MaxLength="5000" onChange="Replace_SpecialChars(this);" onKeyPress="Replace_SpecialChars(this);" onkeyup="Replace_SpecialChars(this);"></asp:TextBox>
                                            </td>
                                            <td style="border: 1px solid Black; border-collapse: collapse; width: 250px; vertical-align: top; margin-top: 2px">
                                                <asp:TextBox ID="txt_item_quantity" runat="server" autocomplete="off" CssClass="txt" MaxLength="5" Font-Bold="true" ForeColor="Black" Font-Size="12px" TabIndex="3" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"></asp:TextBox>
                                            </td>

                                            <td style="border: 1px solid Black; border-collapse: collapse; width: 250px; vertical-align: top; margin-top: 2px">

                                                <asp:TextBox ID="txt_item_cost" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);word.innerHTML=convertNumberToWords(this.value)" onKeyPress="intOnly(this);"></asp:TextBox>
                                                <div id="word"></div>
                                            </td>

                                            <td style="border: 1px solid Black; border-collapse: collapse; width: 250px; vertical-align: top; margin-top: 2px">

                                                <asp:TextBox ID="TextBox2" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);word.innerHTML=convertNumberToWords(this.value)" onKeyPress="intOnly(this);"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table id="Table2" class="body_txt_in" style="border: 1px solid Black; border-collapse: collapse; width: 90%" cellspacing="0" cellpadding="6">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center" style="height: 50px;">
                                            <td style="border: 1px solid Black; border-collapse: collapse">
                                                    <span style="font-size:14px;color:black"><strong>Rs.</strong></span>
                                                <asp:TextBox ID="TextBox3" runat="server" autocomplete="off" CssClass="txt" Style="position: static" Height="24px" TabIndex="2" TextMode="MultiLine" Width="250px" MaxLength="5000" onChange="Replace_SpecialChars(this);" onKeyPress="Replace_SpecialChars(this);" onkeyup="Replace_SpecialChars(this);"></asp:TextBox>
                                            </td>
                                            <td style="border: 1px solid Black; border-collapse: collapse; width: 250px; vertical-align: top; margin-top: 2px">
                                                 <span style="font-size:14px;color:black"><strong>Rs.</strong></span>
                                                   <asp:TextBox ID="TextBox4" runat="server" autocomplete="off" CssClass="txt" MaxLength="5" Font-Bold="true" ForeColor="Black" Font-Size="12px" TabIndex="3" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);" onKeyPress="intOnly(this);"></asp:TextBox>
                                            </td>

                                            <td style="border: 1px solid Black; border-collapse: collapse; width: 250px; vertical-align: top; margin-top: 2px">
                                                    <span style="font-size:14px;color:black"><strong>Rs.</strong></span>
                                                <asp:TextBox ID="TextBox5" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);word.innerHTML=convertNumberToWords(this.value)" onKeyPress="intOnly(this);"></asp:TextBox>
                                                <div id="Div2"></div>
                                            </td>
                     ...
                     <tr>
                        <td style="height: 15px;">
                         ...
                         <td   style="height: 15px;">
                            <div align="left" style="margin-left: 20px">
                                 <span style="font-size:14px;color:black"><strong>Rs.</strong></span>
                                                <asp:TextBox ID="TextBox6" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);word.innerHTML=convertNumberToWords(this.value)" onKeyPress="intOnly(this);"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                       <tr>
                     ...
                     <tr>
                        <td style="height: 15px;">
                         ...
                         <td  style="height: 15px;">
                            <div align="left" style="margin-left: 20px">
                                 <span style="font-size:14px;color:black"><strong>Rs.</strong></span>
                                                <asp:TextBox ID="TextBox7" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px" onChange="intOnly(this);" onKeyUp="intOnly(this);word.innerHTML=convertNumberToWords(this.value)" onKeyPress="intOnly(this);"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <div align="right" style="margin-right: 110px">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btn_preview" runat="server" Width="160px" Height="28px" Font-Bold="true" TabIndex="7" Text="Save and Preview" CausesValidation="False" />
                                        </td>
                                    </tr>
                ...
                <tbody>
                    ...
                    <div id="div1" runat="server">
                        ...
                        <tr>
                            <td colspan="3">
                                <div align="left" style="margin-left: 20px">
                                    <%--<asp:GridView ID="DG2" runat="server" Width="90%"  AutoGenerateColumns="False" DataKeyNames="Record_Id,Reference_No" ShowFooter="true" CellSpacing="4"  CellPadding="6" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" OnRowCreated="GrdView2_RowCreated" OnRowDataBound="GridView2_RowDataBound" >--%>

                                    <asp:GridView ID="DG2" runat="server" Width="90%" AutoGenerateColumns="False" ShowFooter="true" CellSpacing="4" CellPadding="6" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px">
                                        <RowStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <EmptyDataRowStyle HorizontalAlign="Center" VerticalAlign="Middle" BorderColor="Black" BorderWidth="0px" Font-Bold="True" ForeColor="Red" />
                                        <Columns>
                                    ...
                                    <tr>
                                        <td width="20%">
                                            <div align="left" style="margin-left: 30px">
                                                <asp:Button ID="btn_edit" runat="server" Width="90px" Height="28px" Font-Bold="true" TabIndex="1" Text="Edit" CausesValidation="False" />
                                            </div>
                                            ...
                                            <div align="right" style="margin-left: 500px">
                                                ...
                                                <table style="width: 100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btn_submit" runat="server" Width="140px" Height="28px" Font-Bold="true" TabIndex="2" Text="Submit" />
