<%@ Page Title="" Language="C#" MasterPageFile="~/Individual_Users/MasterPage.master" AutoEventWireup="true" CodeFile="View_Individual_Approval_Status_Step3.aspx.cs" Inherits="Individual_Users_View_Individual_Approval_Status_Step3" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Director_Approval_Remarks" HeaderText="Director  Remarks" DataFormatString="{0:dd-MMM-yyyy}" />
                                         <asp:TemplateField HeaderText="Edit">
                                            ...
                                            <ItemTemplate>                                               
                                                <%#Eval("Sub_Head").ToString()=="Travel"?"<a href='Edit_Form_Travel.aspx?Approval_No="+Eval("Approval_No").ToString()+"'>Edit Approval</a>":"<a href='Edit_Form.aspx?Approval_No="+Eval("Approval_No").ToString()+"'>Edit Approval</a>" %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
