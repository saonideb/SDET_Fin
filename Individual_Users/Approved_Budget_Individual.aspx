<%@ Page Title="" Language="VB" MasterPageFile="~/Individual_Users/MasterPage.master" AutoEventWireup="false" CodeFile="Approved_Budget_Individual.aspx.vb" Inherits="Individual_Users_Approved_Budget_Individual" %>
                ...
                <tr valign="top">
                    <td class="head_already" style="height: 30px">
                        <div style="text-align: center">
                         <%--   <span>&nbsp;<span style="text-decoration: none">Approved Budget</span></span>--%>
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="height: 30px; text-align: center;" colspan="3">
                            <div align="center">
                                <asp:GridView ID="DG1" runat="server" Width="100%" CellSpacing="3" CellPadding="5" DataKeyNames="Financial_Year,Head,Sub_Head,Approved_Amount,Department_Id" AutoGenerateColumns="False" BorderColor="#800000" BorderStyle="Solid" BorderWidth="1px" OnRowDataBound="GridView_RowDataBound">
                                    ...
                                    <Columns>
                                      ...
                                      <%--  <asp:BoundField DataField="Main_Head" HeaderText="Main Head" ItemStyle-Font-Size="14px" />                    --%>             
                                        ...
                                        <%-- <asp:TemplateField HeaderText="Sub_Head" ItemStyle-Font-Size="14px">                                           
                                            <ItemTemplate>
                                             <asp:Label ID="lbl_2333" runat="server" Text='<%# Eval("Sub_Head")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:BoundField DataField="Approved_Amount" HeaderText="Approved Amount" HtmlEncode="false" DataFormatString="{0:f}" ItemStyle-Font-Bold="true" ItemStyle-ForeColor="darkred" ItemStyle-Font-Size="15px" />
                                          ...
                                          <asp:TemplateField HeaderText="Spend Amount <br> (Estimated)">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <%--<%#Get_SpendAmount(Eval("Head").ToString(), Eval("Sub_Head").ToString(), Eval("Project_Title").ToString())%>--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
