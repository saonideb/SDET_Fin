<%@ Page Title="" Language="C#" MasterPageFile="~/Individual_Users/MasterPage.master" AutoEventWireup="true" CodeFile="Edit_Form_Travel.aspx.cs" Inherits="Individual_Users_Edit_Form_Travel" %>
        ...
        <asp:Panel ID="Panel1" runat="server">
            <table border="0" class="body_txt_in" cellpadding="0" cellspacing="0" style="width: 90%; height: 55px; border: 1px solid black">
                <tbody>
                                    ...
                                    <asp:GridView ID="grd_Travel_details" runat="server" ShowFooter="True" ShowHeaderWhenEmpty="true" Width="50%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name and Designation">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Button ID="ButtonAdd" runat="server" Width="140px" Height="28px" TabIndex="5" Text="Save and Add More" 
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center" style="height: 50px;">
                                            <td style="border: 1px solid Black; border-collapse: collapse;width: 250px;">
                                                ...
                                                <asp:TextBox ID="txt_rail_fare" runat="server" autocomplete="off" onkeypress="return fnAllowNumeric();" CssClass="txt_rail_fare txt" Style="position: static" Height="24px" TextMode="MultiLine" Width="250px" MaxLength="5000" ></asp:TextBox>
                                            </td>
                                            <td style="border: 1px solid Black; border-collapse: collapse; width: 250px; vertical-align: top; margin-top: 2px">
                                                <span style="font-size: 14px; color: black"><strong>Rs.</strong></span>
                    ...
                    <asp:TextBox ID="txt_Accommodation_Total_Amount" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="80px" Height="18px"></asp:TextBox></td>
                    ...
                    <asp:TextBox ID="txt_Food_Expenses_total_Amount" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="80px" Height="18px"></asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td style="height: 15px;">
                            <div align="left" style="margin-left: 20px">
                                <span style="font-size: 14px; color: black"><strong>Rs.</strong></span>
                                <asp:TextBox ID="txt_Registration_fee" runat="server" onkeypress="return fnAllowNumeric();" autocomplete="off" CssClass="txt" MaxLength="10" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="height: 15px;">
                            <div align="left" style="margin-left: 20px">
                                <span style="font-size: 14px; color: black"><strong>Rs.</strong></span>
                                <asp:TextBox ID="txt_total_Amount" runat="server" autocomplete="off" CssClass="txt" MaxLength="10" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="250px" Height="24px"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
            ...
            <table border="0" class="body_txt_in" cellpadding="0" cellspacing="0" style="width: 90%; height: 55px; border: 1px solid black;">
                <tbody>
                    ...
                    <tr>
                        <td colspan="3">
                            <div align="left" style="margin-left: 20px">
                                <table id="Table4" class="body_txt_in" style="border: 1px solid Black; width: 25%; border-collapse: collapse;" cellspacing="0" cellpadding="6">
                                    <tbody>
                    ...
                    <tr>
                        <td colspan="3">
                            <div align="left" style="margin-left: 20px">
                                <table id="Table5" class="body_txt_in" style="border: 1px solid Black; border-collapse: collapse; width: 90%" cellspacing="0" cellpadding="6">
                    ...
                    <tr>
                        <td colspan="3">
                            <div align="left" style="margin-left: 20px">
                                <table id="Table6" class="body_txt_in" style="border: 1px solid Black; border-collapse: collapse; width: 90%" cellspacing="0" cellpadding="6">
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="center" style="background: #F4F4F4">
                                            <td style="border: 1px solid Black; border-collapse: collapse"><span style="font-size: 12px; color: black"><strong>Accommodation</strong></span></td>
                                            <td style="border: 1px solid Black; border-collapse: collapse"  colspan="2"><span style="font-size: 12px; color: black"><strong>Food Expenses</strong></span></td>
                                            
                                        </tr>
                                        <tr align="center" style="height: 50px;">
                                            <td style="border: 1px solid Black; border-collapse: collapse"><span style="font-size: 14px; color: black"><strong>Rs.</strong></span>@
                                                <asp:Label ID="txt_Accommodation_Rate_P" runat="server" autocomplete="off"  TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px"  ></asp:Label> &nbsp;for &nbsp; 
                    <asp:Label ID="txt_Accommodation_Day_P" runat="server" autocomplete="off"  MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" ></asp:Label>days = Rs.
                    <asp:Label ID="txt_Accommodation_Total_Amount_P" runat="server" autocomplete="off"  MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px"  ></asp:Label></td>
                                            <td style="border: 1px solid Black; border-collapse: collapse" colspan="2"><span style="font-size: 14px; color: black"><strong>Rs.</strong></span>@ 
                    <asp:Label ID="txt_Food_Rate_P" runat="server" autocomplete="off"  MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" ></asp:Label>&nbsp; for <asp:Label ID="txt_Food_Day_P" runat="server" autocomplete="off"  MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px" Width="25px" Height="18px"></asp:Label>days = Rs. 
                    <asp:Label ID="txt_Food_Expenses_total_Amount_P" runat="server" autocomplete="off"  MaxLength="10" TabIndex="4" Font-Bold="true" ForeColor="Black" Font-Size="12px"  ></asp:Label></td>
