<%@ Page Title="" Language="VB" MasterPageFile="~/Individual_Users/Individual.master" AutoEventWireup="false" CodeFile="Login.aspx.vb" Inherits="Individual_Users_Login" %>
                        ...
                        <table border="0" class="body_txt_in" align="left" cellpadding="3" cellspacing="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 1%"></td>
                                    <td align="left" style="height: 30px; width: 266px;">&nbsp;<asp:Button ID="Submit" runat="server" Text="Submit" Font-Bold="True" TabIndex="4" Height="30px" Width="80px" />
                                        &nbsp;<asp:Button ID="Reset" runat="server" Text="Reset" Font-Bold="True" TabIndex="5" Height="30px" Width="80px" CausesValidation="false" />
                                    </td>
                                </tr>
