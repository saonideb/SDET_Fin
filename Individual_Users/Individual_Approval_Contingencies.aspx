<%@ Page Title="" Language="VB" MasterPageFile="~/Individual_Users/MasterPage.master" AutoEventWireup="false" CodeFile="Individual_Approval_Contingencies.aspx.vb" Inherits="Individual_Users_Individual_Approval_Contingencies" %>
                ...
                <tbody>
                  <%-- <tr>
                     ...
                     <tr>
			            <td colspan="3" style=" height: 15px;">
                          <div align="right" style="margin-right:20px">
                              <span style="font-size:16px;color:black"><strong>CONTINGENCIES</strong></span>
                          </div>
			            </td>
			        </tr>
                    ...
                    <tr>
			            <td colspan="3" style=" height: 15px;" align="center">
                          <div>
                              <span style="font-size:14px;color:black"><strong>PROFORMA FOR APPROVAL FOR PURCHASE OF CONTINGENCIES</strong></span>
                          </div>
			            </td>
			        </tr>
                     <tr>
                    ...
                    <tr>
			            <td colspan="3" style=" height: 15px;"">
                        <div align="left" style="margin-left:20px" >
                            <strong>Details of contingencies:</strong>
                        </div>
			            </td>
			        </tr>
                                 ...
                                 <tbody>			
                                   ...
                                   <tr align="center" style="height:50px;width:450px"> 
							        <td style="border:1px solid Black;border-collapse:collapse">
                                         <asp:TextBox ID="txt_item_description" runat="server" autocomplete="off" CssClass="txt" Style="position: static"  Height="60px" TabIndex="2" TextMode="MultiLine" Width="490px" MaxLength="5000" onChange="Replace_SpecialChars(this);"  onKeyPress="Replace_SpecialChars(this);" onkeyup="Replace_SpecialChars(this);"></asp:TextBox>
							        </td>
