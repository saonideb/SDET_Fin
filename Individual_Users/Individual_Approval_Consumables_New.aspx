<%@ Page Title="" Language="C#" MasterPageFile="~/Individual_Users/MasterPage.master" AutoEventWireup="true" CodeFile="Individual_Approval_Consumables_New.aspx.cs" Inherits="Individual_Users_Individual_Approval_Consumables_New" %>
			            ...
			            <td colspan="3">
                           <div align="right" style="margin-right:110px" >
                               <table>
                                   <tr>
                                       <td>
                                            <asp:Button ID="btn_preview" runat="server" Width="160px" ValidationGroup="lab11" Height="28px" Font-Bold="true" OnClick="btn_preview_Click"  TabIndex="7" Text="Save and Preview" />
                                       </td>
                                   </tr>
        ...
        <asp:Panel ID="Panel2" runat="server" Visible="false">
           ...
           <table border="0" class="body_txt_in" cellpadding="0" cellspacing="0" style="width: 90%; height: 55px; border: 1px solid black;">
                <tr id="tr_edit1" runat="server">
                                            ...
                                            <div align="right" style="margin-left:500px">
                                                ...
                                                <table Style="width:100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                             <asp:Button ID="btn_submit" runat="server" Width="140px" OnClientClick="return confirmation();" Height="28px" Font-Bold="true" OnClick="btn_submit_Click"  TabIndex="2" Text="Submit"   />
			            ...
			            <td colspan="3">
                            <div align="center">
                                       <asp:Label ID="lbl_error_message" Font-Bold="true" ForeColor="Red" Font-Size="22px" runat="server" Text=""></asp:Label>
                            </div>
